...
CORS_ALLOWED_ORIGINS=https://turnouy.com
```
...
- [ ] CI/CD — push imágenes a GHCR + workflow de deploy SSH
- [ ] Cron de backup configurado en el server
- [ ] Validación fail-fast de variables de entorno en el backend
